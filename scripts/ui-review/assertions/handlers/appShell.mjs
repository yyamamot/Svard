import { buildAppShellCodexAssertions } from "./appShell/codex.mjs";
import {
  buildAppShellAgentOpenUiAssertions,
  buildAppShellAgentChatAssertions,
} from "./appShell/agentChat.mjs";
  ...
  return {
    ...
    hasTopbarLayoutMenu:
      scenario === "viewer-topbar-direct-layout-controls"
        ...
        : true,
    ...(await buildAppShellCodexAssertions(context)),
    ...(await buildAppShellAgentOpenUiAssertions(context)),
    hasSelectionExtraction:
      scenario === "viewer-selection-extraction"
        ...
        : true,
    ...(await buildAppShellAgentChatAssertions(context)),
    hasSplitBasic:
