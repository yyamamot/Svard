...
#[serde(rename_all = "camelCase")]
struct AgentChatHandoffSnapshot {
    version: u8,
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
struct AgentChatWindowOpenRequest {
    #[serde(default)]
...
pub(crate) struct PendingAgentChatWindows {
    requests: Mutex<BTreeMap<String, AgentChatWindowOpenRequest>>,
    labels_by_origin: Mutex<BTreeMap<String, String>>,
    session_by_origin: Mutex<BTreeMap<String, String>>,
    closed_windows: Mutex<BTreeSet<String>>,
}
...
#[tauri::command]
fn take_current_agent_chat_window_request(
    window: tauri::WebviewWindow,
    pending: tauri::State<PendingAgentChatWindows>,
...
#[tauri::command]
fn route_agent_chat_owner_sync(
...
#[tauri::command]
fn route_agent_chat_origin_action(
