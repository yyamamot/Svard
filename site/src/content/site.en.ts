  ...
  docs: {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            body: "Use path, MkDocs, VitePress, Docusaurus, or Antora order when browsing supported documents.",
            state: "Available",
    ...
    features: {
      ...
      documentsOrder: {
        ...
        whatThisFeatureIs:
          "Svard can show supported documents by file path, static MkDocs nav order, VitePress sidebar order, Docusaurus sidebars order, or local Antora navigation order when those sources are detected. This keeps a document set closer to the reading order used by the published docs without running the site generator.",
        whenToUse:
        ...
        workflow: [
          {
            ...
            body: "Open Files, switch to Documents only, then choose Docs: Path, Docs: MkDocs, Docs: VitePress, Docs: Docusaurus, or Docs: Antora from the view mode menu when available.",
            screenshot: screenshot(
              "documents-order.png",
          ...
          },
          {
            ...
            body: "MkDocs uses static mkdocs.yml nav and docs_dir. VitePress uses themeConfig.sidebar. Docusaurus uses sidebars.* and local autogenerated sidebar metadata. Antora uses local antora.yml nav files and standard antora-playbook.yml content roots as discovery hints.",
          },
        ],
        supportMatrix: {
          ...
          rows: [
            ...
            [
              "VitePress static sidebar",
              "Supported",
              "Reads local .vitepress/config.* themeConfig.sidebar without running VitePress, Vite, or TypeScript.",
            ],
            [
              "Docusaurus static sidebars",
              "Supported",
              "Reads local sidebars.* plus static docs path and autogenerated sidebar metadata without running Docusaurus.",
            ],
            [
              "Generated or plugin nav",
              "Unsupported",
              "MkDocs plugins, VitePress plugin-generated sidebars, Docusaurus custom generators, Antora extensions, remote fetch, and build-generated navigation are not executed.",
            ],
            [
              "Missing nav entries",
              "Partial",
        ...
        limitations:
          "Svard does not execute MkDocs plugins, VitePress / Vite / TypeScript config, Docusaurus builds, Docusaurus custom sidebar generators, Antora builds, Antora extensions, remote repository fetches, or generated navigation. Unsupported or dynamic navigation falls back to path order or shows only the local static subset that can be read safely.",
