  ...
  docs: {
    ...
    guides: {
      aiAgentChangeReview: {
        ...
        whatThisFeatureIs:
          "Svard helps people verify changes that already exist in local files or Git comparisons as rendered documents. It does not run an AI agent or determine whether a particular change was generated by AI.",
        whenToUse:
