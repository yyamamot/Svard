...
import { aiChatDocsEn } from "./docs.ai-chat.en";
...
export const site = {
  ...
  top: {
    ...
    secondaryLink: {
      ...
      href: sitePath("en/docs/guides/ai-agent-change-review/"),
    },
    screenshot: {
      ...screenshot(
        "rendered-diff.png",
    ...
    diff: {
      label: "Full Preview",
      title: "Start with the change readers will see",
      body: "Full Preview places the rendered document before and after an AI agent change side by side. Review changes to prose, lists, tables, and diagrams together with the surrounding document context.",
    },
    reviewFlow: {
      label: "Review workflow",
      title: "From one rendered diff to many changed documents",
      body: "Understand a change in Full Preview, extend the same review across many documents with All Diffs, then return to the normal reader to check the document as a whole.",
      steps: [
        {
          title: "Read in Full Preview",
          body: "Compare rendered results before and after the change, keeping reader-visible differences close to their surrounding context.",
        },
        {
          title: "Extend with All Diffs",
          body: "Open changed documents as one review, then use Files, Previous / Next, and the overview ruler to move through the review set.",
        },
        {
          title: "Verify in reading context",
          body: "Use the Subtle Change Review Mode to find changes, then press and hold a margin marker to reveal the Base temporarily with Revision Lens.",
        },
      ],
      link: {
        label: "Read the AI agent change review workflow",
        href: sitePath("en/docs/guides/ai-agent-change-review/"),
      },
    },
    faq: [
  ...
  docs: {
        ...
        items: [
          {
            ...
            title: "Review changed documents",
            body: "Follow one workflow from Full Preview through All Diffs and Change Review Mode.",
            state: "Available",
            href: sitePath("en/docs/guides/ai-agent-change-review/"),
          },
        ],
        ...
        items: [
          {
            ...
            body: "Prepare Codex and send the first question.",
            state: "Available",
            href: sitePath("en/docs/features/ai-chat/"),
          },
          {
            slug: "ai-chat-context-access",
            title: "Context and Agent Access",
            body: "Understand explicit document context and operating boundaries.",
            state: "Available",
            href: sitePath("en/docs/features/ai-chat-context-access/"),
          },
          {
            slug: "ai-chat-conversation-review",
            title: "Conversations and change review",
            body: "Manage conversations, placements, running input, and change review.",
            state: "Available",
            href: sitePath("en/docs/features/ai-chat-conversation-review/"),
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            body: "Copy text, source, images, diagrams, and diffs with provenance.",
            state: "Available",
            href: sitePath("en/docs/features/copy-references-for-ai/"),
          },
          {
    ...
    guides: {
      aiAgentChangeReview: {
        title: "Review documentation changed by AI agents",
        lead: "Understand one change in Full Preview, extend the same review across many documents with All Diffs, then verify the whole document in the normal reader.",
        whatThisFeatureIs:
          "Svard helps people verify changes that already exist in local files or Git comparisons as rendered documents. It does not determine whether a change came from AI, and you can explicitly add a document or change to AI Chat when discussion is useful.",
        whenToUse:
          "Use this when an AI agent changes several Markdown or AsciiDoc documents and source diffs alone make reader impact or review order difficult to judge. The same workflow also applies to ordinary documentation changes made by people.",
        workflow: [
          {
            title: "Read the reader-visible change in Full Preview",
            body: "Place the rendered document before and after the change side by side. Start with Full Preview to inspect prose, lists, tables, and diagrams together with their surrounding context. Use Changes Only for a shorter pass over changed areas, or Source when exact source lines matter.",
            screenshot: screenshot(
              "rendered-diff.png",
              "Rendered diff in Full Preview",
              "Shows the document before and after a change side by side in Full Preview.",
              "Svard Full Preview showing a rendered document diff",
            ),
          },
          {
            title: "Extend the review across many documents with All Diffs",
            body: "Open All Diffs from Source Control Changes, Branch Diff, or a commit in Repo Graph. Use Files to understand the review set, then Previous / Next and the overview ruler to move through it. Each document keeps the same rendered review model as Full Preview.",
            screenshot: screenshot(
              "source-control-all-diffs.png",
              "Reviewing many documents with All Diffs",
              "Shows Files, the current position, Previous and Next, and the overview ruler across multiple documents.",
              "Svard All Diffs reviewing multiple changed documents",
            ),
          },
          {
            title: "Choose the comparison scope",
            body: "Use Changes for current working-tree changes, Branch Diff for a branch-wide comparison, or Repo Graph for a selected commit. Each entry point is read-only and does not stage, commit, or merge changes.",
            screenshot: screenshot(
              "source-control-changes.png",
              "Choose a review scope in Source Control",
              "Shows local document changes prepared as review targets.",
              "Svard Source Control showing changed documents",
            ),
          },
          {
            title: "Read the whole document with Change Review Mode",
            body: "Return to the normal reader and enable Change Review Mode. Subtle keeps the document unhighlighted and uses range markers in the left margin. Detailed makes changed regions explicit when stronger visibility is useful.",
            screenshot: screenshot(
              "change-review-mode-markers.png",
              "Change markers in the normal reader",
              "Shows Change Review Mode locating changes in the full document.",
              "Svard Change Review Mode showing change markers",
            ),
          },
          {
            title: "Reveal the Base temporarily with Revision Lens",
            body: "Press and hold a left-margin marker to replace the corresponding rendered block with its Base. Release the marker to return to the Working Tree, keeping your reading position for repeated comparison.",
          },
        ],
        limitations:
          "Revision Lens applies to current working-tree changes whose Base can be resolved safely. Content that cannot be mapped is shown as Base unavailable instead of using a guessed comparison. Svard does not retain change reasons or AI agent execution history, and it does not decide whether a review is correct.",
        related: [
    ...
    features: {
      ...
      privacyModel: {
        ...
        whatThisFeatureIs:
          "Svard treats local documents, diagrams, and comparison results as local-first data. Only when you use AI Chat does it send a question, the current document's relative path, explicitly added context, and the selected Agent Access settings to a locally installed Codex.",
        whenToUse:
        ...
        workflow: [
          ...
          {
            title: "Confirm what AI Chat receives",
            body: "The current document body is not attached automatically. Selections, images, diagrams, and changes are sent only when you add them, and Agent Access defines the operations Codex may perform.",
          },
        ],
        limitations:
      ...
      readingMarkup: {
        ...
        whatThisFeatureIs:
          "The reader opens Markdown and AsciiDoc in the same reading surface. Headings, lists, tables, and math are shown as documents, and Svard does not rewrite the source file for viewer convenience.",
        whenToUse:
        ...
        workflow: [
          ...
          {
            title: "Read math and collapsible details",
            body: "Svard renders Markdown inline and display math, AsciiDoc stem math, and short compact details blocks. It preserves boundaries that keep identifiers and currency from becoming math, and it does not enable arbitrary raw HTML.",
            screenshot: screenshot(
              "reading-math-details.png",
              "Math and compact details",
              "Shows rendered math and a safe collapsible details block in Markdown.",
              "Svard showing Markdown math and compact details",
            ),
          },
        ],
        limitations:
          "Svard is not an editor. It does not promise authoring features, live collaboration, or full compatibility with every publishing system. Compact Markdown details use a limited safe syntax and arbitrary raw HTML remains disabled.",
        related: [
          "Table of contents",
          "Tabs and Open Files",
          "Current file search",
      ...
      previewDiffReview: {
        ...
        workflow: [
          ...
          {
            title: "Review changes in Full Preview",
            body: "Start with Full Preview to keep the rendered documents before and after the change together with their surrounding context. Range markers in each left margin locate changes in that pane, while the overview ruler on the right shows their distribution across the document. Previous / Next moves through the displayed changes.",
            screenshot: screenshot(
              "rendered-diff.png",
              "Rendered diff in Full Preview",
              "Shows the document before and after a change in Full Preview.",
              "Svard Full Preview showing a rendered document diff",
            ),
          },
          {
            title: "Switch views for a specific question",
            body: "Use Changes Only for a shorter pass over changed areas, Source for exact source lines, and Table for supported cell-level table review. Overview provides a summary entry point for choosing what to inspect.",
          },
        ],
        limitations:
      ...
      changeReviewMode: {
        ...
        whatThisFeatureIs:
          "When the open document has current local changes, Svard can mark changed text, list items, and table areas near the rendered content. Subtle keeps the document unhighlighted and uses range markers in the left margin, while Detailed also makes changed regions explicit. Pressing a margin marker temporarily reveals the corresponding Base through Revision Lens. This is disabled by default.",
        whenToUse:
        ...
        workflow: [
          ...
          {
            title: "Choose Subtle or Detailed visibility",
            body: "Subtle keeps attention on the document and uses only left-margin range markers to locate changes. Switch to Detailed when changed regions need stronger visibility. Both keep the review in the full reading context instead of opening the dedicated diff workspace.",
            screenshot: screenshot(
              "change-review-mode-markers.png",
          ...
          {
            title: "Press a margin marker to view the Base",
            body: "Press and hold the left-margin marker for a change to replace the corresponding rendered block with its Base. Release the marker to return to the Working Tree while keeping the same reading position.",
          },
        ],
        limitations:
          "This feature is disabled by default. Revision Lens only applies to current working-tree changes whose Base can be resolved safely. Unmapped content is shown as Base unavailable instead of using a guessed comparison. The mode does not stage, commit, merge, or edit content.",
        related: [
          "Table and list diff review",
          "Changes list",
          "Preview-based diff review",
      ...
      sourceControlChanges: {
        ...
        workflow: [
          ...
          },
          {
            ...
            body: "Open All Diffs to review supported Markdown and AsciiDoc changes as one review. Files shows the document set and current position; Previous / Next, left-margin change markers, and the overview ruler move through the review. Each document keeps the same rendered output used by Full Preview.",
            screenshot: screenshot(
              "source-control-all-diffs.png",
              "All Diffs review session",
              "Shows a multi-document review set and current position in All Diffs.",
              "Svard All Diffs showing a multi-document review session",
            ),
          },
          {
            title: "Keep reviewing as the working tree changes",
            body: "A review session in Documents or Source Control preserves your position. Review watch can refresh the set as the working tree changes and shows when an open Diff Preview has become stale.",
          },
        ],
        limitations:
      ...
      branchDiff: {
        ...
        workflow: [
          ...
          {
            title: "Review branch documents with All Diffs",
            body: "Instead of opening documents one by one, use All Diffs to move through the selected base-branch comparison as one continuous document review.",
          },
        ],
        limitations:
      ...
      repoGraph: {
        ...
        workflow: [
          ...
          {
            title: "Review the selected commit with All Diffs",
            body: "Open All Diffs from commit details to move through the supported documents changed by that commit as one rendered review.",
          },
        ],
        limitations:
