  ...
  docs: {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            title: "文書の並び順",
            body: "Path / MkDocs / VitePress / Docusaurus / Antora の順序で対応文書を表示します。",
            state: "公開中",
    ...
    features: {
      ...
      documentsOrder: {
        ...
        whatThisFeatureIs:
          "Svard は対応文書をファイルパス順、静的な MkDocs nav 順、VitePress sidebar 順、Docusaurus sidebars 順、またはローカル Antora nav 順で表示できます。サイトジェネレーターを実行せず、公開ドキュメントで使われる読書順に近い入口を作ります。",
        whenToUse:
          "Markdown / AsciiDoc ファイルが多く、ファイルツリーの並びと読者が読む順序が一致しないフォルダで使います。",
        workflow: [
          {
            title: "文書の順序を選ぶ",
            body: "Files で Documents only に切り替え、利用可能な場合は表示モードメニューから Docs: Path、Docs: MkDocs、Docs: VitePress、Docs: Docusaurus、Docs: Antora を選びます。",
            screenshot: screenshot(
              "documents-order.png",
              "静的サイトの文書の並び順",
          ...
          {
            title: "静的に読める範囲だけを使う",
            body: "MkDocs は静的な mkdocs.yml の nav と docs_dir、VitePress は themeConfig.sidebar、Docusaurus は sidebars.* とローカル autogenerated sidebar metadata、Antora はローカルの antora.yml nav と標準 antora-playbook.yml の content root を使います。",
          },
        ],
        supportMatrix: {
          title: "対応する並び順",
          ...
          rows: [
            ...
            [
              "VitePress の静的 sidebar",
              "対応",
              "ローカルの .vitepress/config.* から themeConfig.sidebar を読みます。VitePress / Vite / TypeScript は実行しません。",
            ],
            [
              "Docusaurus の静的 sidebars",
              "対応",
              "ローカルの sidebars.* と docs path、autogenerated sidebar metadata を読みます。Docusaurus は実行しません。",
            ],
            [
              "生成 nav / プラグイン nav",
              "非対応",
              "MkDocs プラグイン、VitePress の plugin-generated sidebar、Docusaurus custom generator、Antora extension、リモート取得、ビルド後に生成されるナビゲーションは実行しません。",
            ],
            [
              "nav とファイルツリーの差分",
              "部分対応",
        ...
        limitations:
          "Svard は MkDocs プラグイン、VitePress / Vite / TypeScript config、Docusaurus build、Docusaurus custom sidebar generator、Antora ビルド、Antora 拡張、リモートリポジトリ取得、生成 nav を実行しません。動的なナビゲーションはパス順に戻すか、安全に読めるローカルの静的な範囲だけを表示します。",
